...
<body>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../FYP6/userRegistration.jsp">Add New Admin</a></li>
                     <li class="nav-item"><a class="nav-link active" href="../FYP6/linemanager.jsp">My Team</a></li>
    ...
    <div class="container" style="width: 800px;padding: 10px;">
        <br>
        <h1 style="text-align: center;">My New Employees</h1>
        <hr>
    </div>
